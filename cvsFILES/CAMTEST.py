...
def save_to_results_file(data):
    with open("standby.txt",  "a") as f: # Opening the file the data will be stored in
...
#        raspistill -o image.jpg
 #   try:
    #try:
    #    subprocess.run(["pi_cam_uc444.sh"], check = True) 
    #except subprocess.CalledProcessError:
    #    print("Camera Error Detected")
    
 #   except camera.PiCameraRuntimeError:
 #       print ("Error in Camera")

# Executes commands directly from script
    time.sleep(5) 
