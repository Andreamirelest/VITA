...
code_files = ["newSTANDBYMODE.py","newREHYDRATIONMODE.py","newSCIENCEMODE.py","newDECOMMISSIONMODE.py"]
...
def main():
    ...
    programs = ["newSAFEMODE.py", "newSTANDBYMODE.py", "newREHYDRATIONMODE.py", "newSCIENCEMODE.py", "newDECOMMISSIONMODE.py"]
                    ...
                    if choice == "yes":
                        ...
                        while True:
                            ...
                            if code_choice in ["SAFE","STANDBY","REHYDRATION","SCIENCE","DECOMMISSION" ]:
                                ...
                                #run_code(f"new{code_choice.upper()}MODE.py")
                                break
