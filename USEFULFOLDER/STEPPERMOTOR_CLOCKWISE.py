...
# mymotortest.motor_run(GpioPins,.000000000000000000000001,25600000,False,True,"full", .5)
# time.sleep(1)
 input("Press <Enter> to continue Testclockwise")
 mymotortest.motor_run(GpioPins, .0000000000000000000000000001, 25600000, True, True, "full", .5)  #the second false stands for  no data being shown.
 time.sleep(1)
