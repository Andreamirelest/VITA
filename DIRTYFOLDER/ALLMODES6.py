...
def main():
    while True:
        ...
        if run_code("SAFEMODE.py"):
            choice = input("SAFE MODE HAS BEEN COMPLETED! WOULD YOU LIKE TO CONTINUE TO STANDBY MODE? (yes/no/sos):").lower()
        ...
        if choice == "yes":
           ...
           # for code_file in code_files:
            ...
            choice = input ("STANDBYMODE HAS BEEN SUCCESFUL! WOULD YOU LIKE TO CONTINUE TO REHYDRATION MODE? (yes/no/sos):").lower()
        if choise == "sos":
