...
def save_to_results_enviro(data):
    with open("science_enviro.csv",  "a") as f:
        f.write(data)
        f.write("\n")
    print (data)

def save_to_results_spectro(data):
    with open("science_spectro.csv", "a") as f:
        f.write(data)
        f.write("\n")
    print (data)
...
#while True:
    ...
    save_to_results_enviro(data_sensor1)
   ...
   # temperature2, pressure2, humidity2, gas2 = sensor2.data
    ...
    save_to_results_enviro(data_sensor2)
...
#while True:
    ...
    save_to_results_spectro(data_spectro1)
...
#Initialize the BME688 sensor on channel 1 
    ...
    save_to_results_spectro(data_spectro2)
...
#Initialize the BME688 sensor on channel 2 
    ...
    save_to_results_spectro(data_spectro3)
...
#CHANNEL 3 
    ...
    save_to_results_spectro(data_spectro4)
