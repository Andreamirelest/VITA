...
#TARGET TEMPERATURES
SetPoint = [15.0, 20.0, 25.0, 30.0]

#Gains for PID loops
Kp = [1, 1, 1, 1]  #Proportional gains
Ki = [1, 1, 1, 1]  #Integral gains 
Kd = [1, 1, 1, 1]  #Derivative gains
...
HeaterAdresses= [0x01,0x02,0x03,0x04]
TempSensorAdresses= [0x18,0x19,0x1A,0x1B]
    ...
    while True:
     ...
     #prompt the user to enter what loop they want to edit 
        ...
        with  shared_data['lock']:
            ...
            shared_data['Set Point'][i] = setPoint_input
